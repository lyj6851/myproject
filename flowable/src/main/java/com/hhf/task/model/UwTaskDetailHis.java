...
@ApiModel(value="UwTaskDetailHis对象", description="")
public class UwTaskDetailHis extends BaseVersionEntity {
    ...
    @ApiModelProperty(value = "流程任务节点id")
    ...
    @ApiModelProperty(value = "Uw_TASK表主键id")
